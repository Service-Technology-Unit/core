...
/**
 * <p>This is the ConfigProperty data access object interface.</p>
 */
public interface ConfigPropertyDao extends Dao {
	 ...
	 */
	public ConfigProperty findById(Serializable id);
