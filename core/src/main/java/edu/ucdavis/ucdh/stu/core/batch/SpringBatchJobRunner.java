...
public class SpringBatchJobRunner {
	...
	public static void main(String[] args) {
		...
		if (StringUtils.isNotEmpty(springContextFile)) {
		...
		// load batch job schedule id
		try {
			//batchJobScheduleId = Integer.parseInt((String) context.getBean("scheduleId"));
